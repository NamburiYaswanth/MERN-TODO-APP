...
const SingleTask = ({ title, id, completed, i }) => {
  ...
  // setUpdateId(id);
  // setIsDone(!completed) 
  // //then true means it become false why it show the true again can you explain once
  // };
  ...
  const handleCompleted = () => {
    ...
    setIsDone(newCompletedState);
    console.log("Toggled completed state:", newCompletedState);
};
